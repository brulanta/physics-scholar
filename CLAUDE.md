...
- **The plan file (`plan/plan-example.md`) is the cross-session handoff**: it carries the **next-stage todo**, not a log of the current stage's内容; keep its progress/状态 section honest against `git log` before pushing.
